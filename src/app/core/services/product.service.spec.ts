...
describe('ProductService', () => {
  ...
  const mockLocation = [{name: 'here', id: 1}];
  const reskLocation = [{value: 1, label: 'here'}] as OptionsConf[];
  let testUrl;
  ...
  testRequestFunction('getLocations', testUrl, 'GET', mockLocation, reskLocation);
});
